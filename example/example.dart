...
void main() {
  ...
  print(CountryCode.US.alpha3Code); // -> USA
  print(CountryCode.US.numericCode); // -> 840
  print(CountryCode.US.symbol); // -> 🇺🇸

  // The list of countries with ISO-assigned codes are in Country.values
  var list = CountryCode.values.map<String>((CountryCode c) => c.alpha2Code).join(", ");
  print(list);
  ...
  print(CountryCode.ofAlphaCode("US").alpha2Code); // -> US
  print(CountryCode.ofAlphaCode("USA").alpha2Code); // -> US
  print(CountryCode.ofNumericCode(840).alpha2Code); // -> US
  ...
  print(CountryCode.parse("US").alpha2Code); // -> US
  print(CountryCode.parse("USA").alpha2Code); // -> US
  print(CountryCode.parse("840").alpha2Code); // -> US
}
